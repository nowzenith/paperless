                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: InkWell(
                            onTap: () {},
                            child: Container(
                              child: Text("เปลี่ยรหัสผ่าน",
                                  style: TextStyle(
                                      color: Color.fromRGBO(96, 96, 96, 100))),
                            )),
                      ),
                      Align(
                        alignment: AlignmentDirectional(-0.12, -0.56),
                        child: Container(
                          width: 372.1,
                          height: 1,
                          decoration: BoxDecoration(
                      ...
                      Align(
                        alignment: AlignmentDirectional(-0.85, -0.37),
                        child: Icon(
                          Icons.logout,
                          color: Color(0xFF664731),
                          size: 24,
                ...
                child: Container(
                  ...
                  child: Stack(
                    children: [
                      ...
                      Align(
                        alignment: AlignmentDirectional(-0.19, -0.9),
                        child: Text('$name',
                            style: TextStyle(
                              fontFamily: 'Prompt',
                              fontSize: 20,
